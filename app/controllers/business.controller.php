...
class businessController {
    ...
    function deleteClothes($id_clothes) {
        $this->model->deleteClothesById($id_clothes);
    ...
    function upDateClothes($id_clothes) {
        $cloth2=$this->model->upDateClothesById($id_clothes);
    ...
    function EditEnd() {
        ...
        $id = $this->model->editEnd2( $des2,$mar2,$tal2,$col2,$sto2, $pre2, $id);
